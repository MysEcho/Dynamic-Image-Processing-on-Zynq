...
//	sensor_init(&ps_i2c0);
	...
	/* Clear frame buffer */
	memset(dispCtrl.framePtr[dispCtrl.curFrame], 0, 640 * 480 * 3);
	/* Start Sensor Vdma */
	vdma_write_init(XPAR_AXIVDMA_1_DEVICE_ID,640 * 3,480,640 * 3,(unsigned int)dispCtrl.framePtr[dispCtrl.curFrame]);
